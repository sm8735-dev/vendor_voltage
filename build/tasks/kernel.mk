...
## Internal variables
COLLECT_MODULE_DEPS_CMD := python3 $(BUILD_TOP)/voltage/scripts/collect-kernel-module-deps/collect-kernel-module-deps.py --non-interactive
...
ifeq ($(BOARD_USES_QCOM_MERGE_DTBS_SCRIPT),true)
	...
	PATH=$(abspath $(HOST_OUT_EXECUTABLES)):$${PATH} python3 $(BUILD_TOP)/vendor/voltage/build/tools/merge_dtbs.py --base $(DTBS_BASE) --techpack $(DTB_OUT)/arch/$(KERNEL_ARCH)/boot/dts/vendor/ --out $(DTBS_OUT)
